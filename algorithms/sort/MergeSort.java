...
public class MergeSort {
  ...
  public static void main(String[] args) {
    ...
    MergeSorter<String> mg = new MergeSorter<String>();
    mg.mergeSort(a);
    for (String e : a) {
  ...
  public static class MergeSorter<E extends Comparable<E>> {
    ...
    private void merge(Comparable<E>[] a, Comparable<E>[] aux, int lo, int mid, int hi) {
      /**
       * Coping elements of array a to array aux. This step can be avoided by replacing a and aux.
       * But this sometime leads to some insidious bug.
       */
      for (int k = lo; k <= hi; k++) {
        aux[k] = a[k];
      }
