...
/**
 * This class returns the median value of an array.
 * Median is the middle element of the array after it is
 * sorted. If there are even elements in the array median value
 * is the value returned after adding  the two values
 * and then dividing by 2.
 * <br>
 * e.g [1,2,3] has median 3
 * e.g [1,2,3,4] has median 2.5 (2+3) /2
 * @author Kostas
 *
 * version 1.0
 */
public class Median {
	...
	public static void main(String args[]) {
		double[] doubleValues = Arrays.stream(args)
