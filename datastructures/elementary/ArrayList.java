package datastructures.elementary;
...
public class ArrayList {
  ...
  public static void main(String[] args) throws Exception {
    ArrayLister<Integer> al = new ArrayLister<Integer>();
    al.add(1);
    al.add(2);
    al.add(3);
    al.add(4);
   ...
   */
  public static class ArrayLister<E extends Comparable<E>> implements Iterable<E> {
     ...
     */
    public void removeByElement(E item) throws Exception {
      resize();
      int index = 0;
      if (array[0] != item) {
    ...
    /**
     * Clear the array. Note - Actual elements in array will not get deleted. Array will consume
     * space in memory.
     */
    public void clear() {
      ITEM_COUNT = 0;
